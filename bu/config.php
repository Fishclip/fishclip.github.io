 ...
 */
$gallery->setConfig('setup.password', 'sBprzU');
 ...
 */
$gallery->setConfig('data.gallery.base', '/home/virtual/site87/fst/var/www/html//g2data/');
...
$storeConfig['database'] = 'tanstaafl';
$storeConfig['username'] = 'fishclip';
$storeConfig['password'] = 'bacon4me';
